...
void MainWindow::huizhishuxian_x1(int x)
{
    ...
    switch(maxx)
    {
        ...
        case 1:cursor_x1=cursor_x1*diff_cursor_x;break;
        case 16:cursor_x1=cursor_x1*16*0.2*diff_cursor_x;break;
...
void MainWindow::huizhishuxian_x2(int x)
{
    ...
    switch(maxx)
    {
        ...
        case 16:cursor_x2=cursor_x2*16*0.2*diff_cursor_x;break; //320US  3200
...
//        axisX->setMinorTickCount(10);
        ...
        // 设置折线的标题
        series->setName("Chip Creator Team-Loongson");
        // 折线系列添加到图表,//openGl 加速
...
//    qint64 size = data.size();
     ...
     */
    for(i = 0; i < 200; ++i){
        data.append(QPointF(i,max_data*maxy*sin(3.14 * i / 200*m+count)));
        count++;
    }
    series->replace(data);
}
...
{
    int mul=1;
    if(frequency > 1000000) //1000k
    {
         ui->lineEdit->setText(tr("%1").arg((float)frequency/1000000)+"  MHZ"); //ui->lineEdit->setText(tr("%1").arg((float)frequency/1000000)+"  MHZ
         mul=1000000;
    }
    else if (frequency > 1000)    //1000
    {
         ui->lineEdit->setText(tr("%1").arg((float)frequency/1000)+"  KHZ");//arg((float)frequency/1000
         mul=1000;
    }
    else
    {
  ...
  //显示实时电压
    ui->lineEdit_2->setText(tr("%1").arg(max_data*2)+"  v");
    if(mes.isVisible())
    {
...
void MainWindow::handleTimeout()
 {
    ...
    if(frequency<11000)
    {
        ui->radioButton_4->setText("100ns/div");//20us
        ui->radioButton_5->setText("20us/div");//200us
        ui->radioButton_8->setText("20ms/div");//10us
        ui->radioButton_6->setText("2us/div");//200ms
        //diff_cursor_x=1;
        diff_cursor_x=(float)1.0/30;
    }
    else if(frequency<500000)
    {
        ui->radioButton_4->setText("100ns/div");  //2us
        ui->radioButton_5->setText("20us/div");  //20us
        ui->radioButton_8->setText("20ms/div");  //10us
        ui->radioButton_6->setText("2us/div");  //20ms
        //diff_cursor_x=1;
        diff_cursor_x=(float)1.0/30;
    }
    else if(frequency<5000000)
    {
        ui->radioButton_4->setText("100ns/div");   //67ns
        ui->radioButton_5->setText("20us/div"); //0.67us
        ui->radioButton_8->setText("20ms/div");    //10us
        ui->radioButton_6->setText("2us/div");   //0.7ms
        diff_cursor_x=(float)1.0/30;
        //diff_cursor_x=1;
    }
    else
...
void MainWindow::voltageClicked(int m)
{
    switch(m)
    {
        ...
        case 1:max_y=2;break;  //0.1v
        case 2:max_y=500;break;   //0.002v
        case 3:max_y=10;break;
    }
}
